...
const config = (env) => {
  ...
  const config = {
    entry: {
      ...
      'hey-content': paths.rootResolve('src/content-script/hey-content.ts'),
      'twitter-content': paths.rootResolve('src/content-script/twitter-content.js'),
      'warpcast-content': paths.rootResolve('src/content-script/warpcast-content.ts')
